...
| Soporte inicial de macOS | OS X 10.6, Snow Leopard |
...
* `Macmini5,3` - para computadoras que utilizan su iGPU para la imagen.
* `iMac12,2` - para computadoras que usan una GPU dedicada para salida de imagen.
